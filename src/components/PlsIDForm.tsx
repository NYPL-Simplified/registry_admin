...
export class PlsIDForm extends React.Component<PlsIDFormProps, PlsIDState> {
  // The PLS ID is generated by the annual IMLS Public Libraries Survey.  We use it to gather metric data
  // such as "number of covered branches", which gives us a good measure of adoption of SimplyE.
