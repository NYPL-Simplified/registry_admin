...
describe("PlsIDForm", () => {
  ...
  it("renders a form with a title, info message, hidden input field, text input field, and button", () => {
    ...
    expect(infoMessage.text()).to.equal("The PLS ID is generated by the annual IMLS Public Libraries Survey.  We use it to gather metric data such as 'number of covered branches', which gives us a good measure of adoption of SimplyE.");
