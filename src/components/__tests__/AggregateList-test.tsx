...
describe("AggregateList", () => {
  ...
  it("optionally shows geographic information", () => {
    ...
    expect(nameLists.at(0).text()).not.to.contain("(NY)");
    expect(nameLists.at(1).text()).not.to.contain("(NY)");
    ...
    expect(geographicInfoButton.text()).to.equal("Hide Geographic Info");
    expect(nameLists.at(0).text()).to.contain("(NY)");
    expect(nameLists.at(0).text()).to.contain("(NY)");
    expect(nameLists.at(1).text()).to.contain("(NY)");
